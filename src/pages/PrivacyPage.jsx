      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate/10 prose prose-slate max-w-none">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4 text-slate">1. Information We Collect</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4 text-slate">2. How We Use Your Information</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4 text-slate">3. Data Protection and Compliance</h2>
            <p className="mb-6">
              We employ industry-standard administrative and technical safeguards to protect your institutional data against unauthorized access, disclosure, or alteration. We adhere to applicable privacy regulations across the United States and the Republic of the Philippines (including the Data Privacy Act of 2012).
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4 text-slate">4. Data Sharing</h2>
            <p className="mb-8">
              Trendsetter Textiles does not sell, rent, or lease your commercial data to third parties. We only share information with trusted logistics and manufacturing partners strictly to fulfill your orders and deliveries.
            </p>
            ...
            <div className="mt-12 p-6 rounded-lg bg-neutral-bg border border-slate/10">
              ...
              <p className="text-sm m-0">
                If you have questions about our privacy practices, please contact us at <a href={`mailto:${region.email}`} className="text-deep-teal hover:underline font-medium">{region.email}</a>.
              </p>
            </div>
